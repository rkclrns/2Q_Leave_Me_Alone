...
public:
	...
	void OnCollisionEnter(Collider* _origin, Collider* _destination);
	void OnCollisionStay(Collider* _origin, Collider* _destination);
	void OnCollisionExit(Collider* _origin, Collider* _destination);
